...
import { DeleteModal, RestoreModal } from "./Modals.jsx";
...
export default function AdminPanel() {
  ...
  return (
    <div style={{
      ...
      fontFamily: "'Outfit', sans-serif", color: "#e8e6f0",
    }}>
      <style>{`
      ...
      <header style={{
        ...
        <div style={{
          ...
          {!ev.loading && (
            <div style={{
              display: "flex", gap: 20, fontSize: 12, color: "#4a4868",
            }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <a href="/" style={{
              fontSize: 12, color: "#4a4868", textDecoration: "none",
        ...
        <div style={{
          ...
          <div style={{ position: "relative", flex: 1, minWidth: 200 }}>
            <span style={{
              ...
              transform: "translateY(-50%)", color: "#4a4868", fontSize: 14,
              pointerEvents: "none",
            }}>🔍</span>
            <input
              value={search}
            ...
            {search && (
              <button
                ...
                style={{
                  ...
                  color: "#4a4868", cursor: "pointer", fontSize: 16,
                }}
              >×</button>
            )}
          </div>
          ...
          {/* Refresh */}
          <button
            onClick={ev.loadEvents}
            disabled={ev.loading}
            style={{
              padding: "10px 14px", borderRadius: 10, cursor: "pointer",
              background: "rgba(255,255,255,0.04)",
              border: "1px solid rgba(255,255,255,0.08)",
              color: "#6b6890", fontSize: 14,
        ...
        <div style={{
          ...
          {ev.loading ? (
            ...
            <div style={{ padding: 48, textAlign: "center", color: "#ef4444", fontSize: 14 }}>
              ⚠️ {ev.error}
              <button onClick={ev.loadEvents} style={{
                display: "block", margin: "12px auto 0",
                background: "none", border: "1px solid rgba(239,68,68,0.3)",
                color: "#ef4444", borderRadius: 8, padding: "6px 16px",
