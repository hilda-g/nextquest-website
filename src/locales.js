...
export const LANGS = {
  en: {
    ...
    noEvents: "No events found", multiDay: "Multi-day", cancelled: "Cancelled", ended: "Ended",
  ...
  ru: {
    ...
    noEvents: "Событий не найдено", multiDay: "Многодневное", cancelled: "Отменено", ended: "Завершено",
  ...
  el: {
    ...
    noEvents: "Δεν βρέθηκαν εκδηλώσεις", multiDay: "Πολυήμερο", cancelled: "Ακυρώθηκε", ended: "Ολοκληρώθηκε",
  ...
  uk: {
    ...
    noEvents: "Подій не знайдено", multiDay: "Багатоденна", cancelled: "Скасовано", ended: "Завершено",
