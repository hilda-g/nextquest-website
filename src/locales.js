...
export const LANGS = {
  ...
  ru: {
    ...
    formatCommunity: "✨ Community",
    formatOfficial:  "🎉 Official",
    formatDescPrivate:   "Личные события, домашние игры, небольшие сборки",
    formatDescCommunity: "Клубы, регулярные встречи, сообщества",
    formatDescOfficial:  "Большие конвенты, брендированные ивенты, компании",
    ...
    ctaSubscribeSub:   "Не пропусти гик-события на Кипре",
  ...
  el: {
    ...
    formatCommunity: "✨ Community",
    formatOfficial:  "🎉 Official",
    formatDescPrivate:   "Προσωπικές εκδηλώσεις, οικιακά παιχνίδια, μικρές συναντήσεις",
    formatDescCommunity: "Σύλλογοι, τακτικές συναντήσεις, κοινότητες",
    formatDescOfficial:  "Μεγάλα συνέδρια, branded events, εταιρείες",
    ...
    ctaSubscribeSub:   "Μη χάσεις geek εκδηλώσεις στην Κύπρο",
  ...
  uk: {
    ...
    formatCommunity: "✨ Community",
    formatOfficial:  "🎉 Official",
    formatDescPrivate:   "Особисті події, домашні ігри, маленькі збори",
    formatDescCommunity: "Клуби, регулярні зустрічі, спільноти",
    formatDescOfficial:  "Великі конвенти, брендові події, компанії",
