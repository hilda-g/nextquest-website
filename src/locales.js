...
export const LANGS = {
  en: {
    ...
    contactOrganizer: "📋 Contacts & details", organizerContacts: "Organizer contacts",
    noEvents: "No events found", multiDay: "Multi-day", cancelled: "Cancelled", ended: "Ended", ended: "Ended",
    ...
    promoCity:         "Your Cozy Home",
    promoAddEvent:     "⭐ Add Your Event",
  },
  ru: {
    ...
    statusFull: "✕ Мест нет",
    statusOpen: "● Есть места",
    registrationNeeded: "Нужна регистрация",
    eventsBy: "События от",
    ...
    promoCity:         "Твой уютный дом",
    promoAddEvent:     "⭐ Добавить событие",
  },
  el: {
    ...
    contactOrganizer: "📋 Επικοινωνία & Πληροφορίες", organizerContacts: "Στοιχεία διοργανωτή",
    noEvents: "Δεν βρέθηκαν εκδηλώσεις", multiDay: "Πολυήμερο", cancelled: "Ακυρώθηκε", ended: "Ολοκληρώθηκε", ended: "Ολοκληρώθηκε",
    ...
    statusFull: "✕ Πλήρες",
    statusOpen: "● Θέσεις διαθέσιμες",
    registrationNeeded: "Απαιτείται εγγραφή",
    ...
    promoCity:         "Το άνετο σπίτι σου",
    promoAddEvent:     "⭐ Πρόσθεσε εκδήλωση",
  },
  uk: {
    ...
    contactOrganizer: "📋 Контакти та деталі", organizerContacts: "Контакт організатора",
    noEvents: "Подій не знайдено", multiDay: "Багатоденна", cancelled: "Скасовано", ended: "Завершено", ended: "Завершено",
    ...
    statusOpen: "● Є вільні місця",
    registrationNeeded: "Потрібна реєстрація",
    eventsBy: "Події від",
    ...
    promoCity:         "Твій затишний дім",
    promoAddEvent:     "⭐ Додати подію",
  },
};
